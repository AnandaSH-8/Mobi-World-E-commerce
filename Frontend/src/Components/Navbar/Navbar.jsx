    ...
    <div className={Style.navbar}>
      <div className={Style.logo_title}>
        <b>
          {" "}
          <Link
            style={{ textDecoration: "none", color: "rgb(239, 138, 5)" }}
            to="/home"
          >
            Mobi World
          </Link>
      ...
      <div className={Style.smartPhones}>
        ...
        >
          ...
          <MenuItem onClick={handleClose}>
            <Link className="Link" to="/mobiles/under_10000">
              Under 10000
            </Link>
          </MenuItem>
          <MenuItem onClick={handleClose}>
            <Link className="Link" to="/mobiles/under_20000">
              Under 20000
            </Link>
          </MenuItem>
        </Menu>
      ...
      <div className={Style.right_content}>
        <div style={{ display: "flex" }}>
          <AccountCircle
            ...
            style={{ color: username == "username" ? "white" : "orange" }}
          />
        ...
        <div style={{ display: "flex" }}>
          <IconButton aria-label="cart">
            ...
            >
              <StyledShoppingCart className={Style.Icons}></StyledShoppingCart>
            </StyledBadge>
          </IconButton>
