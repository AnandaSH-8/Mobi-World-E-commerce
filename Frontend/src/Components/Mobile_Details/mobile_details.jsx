  ...
  return (
    <div className={Style.Details}>
      ...
      <div className={Style.specs}>
        <h1>{phone?.name}</h1>
        <p>
          <b>Launch Date : </b> {phone?.launch_date}
        </p>
        <p>
          <b>OS : </b> {phone?.os}
        </p>
        <p>
          <b>Screen Size: </b> {phone?.screen} inches
        </p>
        <p>
          <b>Display : </b> {phone?.display}
        </p>
        <p>
          <b>PPI : </b> ~{phone?.PPI} PPI
        </p>
        <p>
          <b>Camera :</b> Rear Camera:- {phone?.camera.rear} MP, Front Camera:-{" "}
          {phone?.camera.front} MP
        </p>
        <p>
          <b>RAM: </b> {phone?.ram} GB
        </p>
        <p>
          <b>Chipset : </b> {phone?.chipset}
        </p>
        <p>
          <b>Processor: </b> {phone?.processor} processor
        </p>
        <p>
          <b>Internal Storage : </b> {phone?.storage}
        </p>
        <p>
          <b>Memory Card : </b> Expandable upto {phone?.sdCard}
        </p>
        <p>
          <b>Weight : </b> {phone?.weight} g
        </p>
        <p>
          <b>Battery : </b> {phone?.battery} mAh, Li-Po Battery
        </p>
